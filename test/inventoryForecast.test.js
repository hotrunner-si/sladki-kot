...
const product = { lead_time_days: 2, safety_stock_quantity: 4 }
...
test('varnostna zaloga je upoštevana kot količina', () => assert.equal(calculateProductForecast({ product: { lead_time_days: 2, safety_stock_quantity: 10 }, counts: [c('2026-01-01', 30), c('2026-01-06', 20)] }).reorderPointQuantity, 14))
